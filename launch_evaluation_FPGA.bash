...
do
  ...
  # The new run_competition.py handles networking itself.
  # The model_type and model_path arguments are no longer needed for the host.
  python3 run_competition_v1.py $run_competition_args --des_vel 5.0 &
  COMP_PID="$!"
